...
@export var player_swap_collision_shape_enabled_checkbutton: CheckButton
...
@export var player_draw_collision_shape_enabled_checkbutton: CheckButton
...
func _ready() -> void:
	...
	player_swap_collision_shape_enabled_checkbutton.button_pressed = SETTINGS.player_swap_collision_shape_enabled
	player_swap_collision_shape_enabled_checkbutton.toggled.connect(
		func (toggled_on : bool) -> void : SETTINGS.player_swap_collision_shape_enabled = toggled_on
	)
	...
	# Player draw collision shape enabled
	player_draw_collision_shape_enabled_checkbutton.button_pressed = SETTINGS.player_draw_collision_shape_enabled
	player_draw_collision_shape_enabled_checkbutton.toggled.connect(
		func (toggled_on : bool) -> void : SETTINGS.player_draw_collision_shape_enabled = toggled_on
	)
